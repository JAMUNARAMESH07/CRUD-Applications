...
fetch("http://localhost:8000/employee&quot",{
method:"POST",
...
{name.length==0 && validation && <span
className="text-danger">Enter the name</span>}
...
onChange={e=>activechange(e.target.checked)} type="checkbox"
className="form-check-input"></input>


                                           
<label 
className="form-check-label">Is Active</label>
